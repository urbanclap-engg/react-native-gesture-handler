...
export declare type SimultaneousGestureType = InstanceType<
  typeof SimultaneousGesture
>;
export declare type ExclusiveGestureType = InstanceType<
  typeof ExclusiveGesture
>;
